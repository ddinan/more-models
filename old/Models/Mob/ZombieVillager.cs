...
namespace MoreModels {
	public class ZombieVillagerModel : IModel {	
		public ZombieVillagerModel(Game window) : base(window) { SurivalScore = 20; }
		...
		ModelPart Head, Nose, Hat, Torso, LeftLeg, RightLeg, LeftArm, RightArm;
	}
}